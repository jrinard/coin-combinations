...
describe('Fixnum#coin_combinations') do
  ...
  expect((65).coin_combinations(10, 10, 10)).to(eq("2 quarters, 1 dime, 1 nickle"))
  end
  it('if you give it 99 cents it returns 2 quarters, 1 dimes, 1 nickle, 4 pennies') do
  expect((69).coin_combinations(10, 10, 10)).to(eq("2 quarters, 1 dime, 1 nickle, 4 pennies"))
  end
  it('if you have only 2 quarters') do
  expect((75).coin_combinations(2, 10, 10)).to(eq("2 quarters, 2 dimes, 1 nickle"))
  end
  it('if you have less than 5 cents') do
  expect((2).coin_combinations(10, 10, 10)).to(eq("2 pennies"))
  end
